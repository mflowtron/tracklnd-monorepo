        ...
        {statCards.map(s => (
          <Card key={s.label}>
            <CardContent className="pt-6">
              ...
              {loading ? <Skeleton className="h-8 w-12 mb-1" /> : <p className="text-3xl font-bold">{s.value}</p>}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-3">
            {loading ? [1, 2, 3].map(i => <Skeleton key={i} className="h-10 w-full" />) : upcomingEvents.length === 0 ? (
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {loading ? [1, 2, 3].map(i => <Skeleton key={i} className="h-10 w-full" />) : recentWorks.length === 0 ? (
